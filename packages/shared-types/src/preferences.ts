 ...
 */
export const SHOW_UNCHANGED_OBJECTS_KEY =
  'platform.objectExplorer.showUnchangedObjects' as const;

/**
 * Default value for the SHOW_UNCHANGED_OBJECTS preference.
 * Unchanged objects are hidden by default.
 */
export const SHOW_UNCHANGED_OBJECTS_DEFAULT = false as const;
